            ...
            <div className="flex flex-wrap justify-center gap-3 max-w-4xl mx-auto">
              {categories.map((cat) => (
                <Link
                  ...
                  className="flex items-center gap-2 px-4 py-2.5 rounded-full border border-gray-200 bg-white hover:border-primary-400 hover:bg-primary-50 hover:text-primary-700 text-gray-700 text-sm font-medium shadow-sm transition-all duration-150"
                >
